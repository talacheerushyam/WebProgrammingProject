	...
	<div id ="cmainDiv">
		...
		<div class="menuBar"> 
		 ...
		 <div style="height:1500px;">
			<h1>Book Tickets</h1>
			<input id="flight_no" name="flight_no" type="hidden" value=<%  out.println(fno); %>/>
			<input id="ticket_no" name="ticket_no" type="hidden" value=<%  out.println(tickets); %>/>
			<input id="user" name="user" type="hidden" value=<%  out.println(username); %>/>
			<input id="ticket_class" name="ticket_class" type="hidden" value=<%  out.println(tclass); %>/>
			<input id="ticket_cost" name="ticket_cost" type="hidden" value=<%  out.println(finalCost); %>/>
			<input id="final_cost" name="final_cost" type="hidden" value=<%  out.println(endCost); %>/>
			<div class="bookTickets">
				...
				if (type.equals("flight"))
				{
					...
					out.print("<input id=\"ticket\" name=\"ticket\" type=\"hidden\" value="+ticket+" />");
